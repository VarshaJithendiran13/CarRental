...
namespace RoadReady.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReservationId,UserId,CarId,PickupDate,DropoffDate,TotalPrice,ReservationStatus")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationId,UserId,CarId,PickupDate,DropoffDate,TotalPrice,ReservationStatus")] Reservation reservation)
        {
