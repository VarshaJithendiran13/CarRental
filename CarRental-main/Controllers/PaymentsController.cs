...
namespace RoadReady.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,ReservationId,Amount,PaymentDate,PaymentMethod,Status")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,ReservationId,Amount,PaymentDate,PaymentMethod,Status")] Payment payment)
        {
